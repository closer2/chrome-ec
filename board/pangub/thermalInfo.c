...
#define UMA_CPU_FAN_START_TEMP  46
#define GFX_SYS_FAN_START_TEMP  36
#define GFX_CPU_FAN_START_TEMP  37
...
/* level    RPM        HowTri       lowTri */
    {0,     800,      37,   UMA_CPU_FAN_START_TEMP},
    {1,     1000,     60,   35},
    {2,     1500,     64,   58},
    {3,     1600,     80,   62},
    {4,     2000,     83,   78},
...
const struct thermal_level_ags i3_gfx_thermal_sys_fan_ssd1_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
    {3,     1500,     58,   54},
    {4,     1800,     61,   57},
...
const struct thermal_level_s t_i3_gfx_thermal_sys_fan_ssd1_ntc = {
    .name = "SSD1 NTC",
    .num_pairs = ARRAY_SIZE(i3_gfx_thermal_sys_fan_ssd1_ntc),
    .data = i3_gfx_thermal_sys_fan_ssd1_ntc,
};

/* GFX sys fan sensor SSD2 NTC*/
const struct thermal_level_ags i3_gfx_thermal_sys_fan_ssd2_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
...
const struct thermal_level_s t_i3_gfx_thermal_sys_fan_ssd2_ntc = {
    .name = "SSD2 NTC",
    .num_pairs = ARRAY_SIZE(i3_gfx_thermal_sys_fan_ssd2_ntc),
    .data = i3_gfx_thermal_sys_fan_ssd2_ntc,
};

/* GFX sys fan sensor MEMORY NTC*/
const struct thermal_level_ags i3_gfx_thermal_sys_fan_memory_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      39,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      55,   38},
    {2,     1200,     58,   54},
    {3,     1500,     60,   57},
    {4,     1800,     62,   59},
...
const struct thermal_level_s t_i3_gfx_thermal_sys_fan_memory_ntc = {
    .name = "Memory NTC",
    .num_pairs = ARRAY_SIZE(i3_gfx_thermal_sys_fan_memory_ntc),
    .data = i3_gfx_thermal_sys_fan_memory_ntc,
};

/* GFX cpu fan CPU DTS */
const struct thermal_level_ags gfx_i3_thermal_cpu_fan_cpu_dts[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     65,   33},
    {2,     1200,     80,   63},
    {3,     1500,     84,   78},
    {4,     1700,     91,   82},
...
const struct thermal_level_s t_i3_gfx_thermal_cpu_fan_cpu_dts = {
    .name = "CPU DTS",
    .num_pairs = ARRAY_SIZE(gfx_i3_thermal_cpu_fan_cpu_dts),
    .data = gfx_i3_thermal_cpu_fan_cpu_dts,
};

/* GFX cpu fan CPU NTC */
const struct thermal_level_ags gfx_i3_thermal_cpu_fan_cpu_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     60,   33},
    {2,     1200,     72,   58},
...
const struct thermal_level_s t_i3_gfx_thermal_cpu_fan_cpu_ntc = {
    .name = "CPU NTC ",
    .num_pairs = ARRAY_SIZE(gfx_i3_thermal_cpu_fan_cpu_ntc),
    .data = gfx_i3_thermal_cpu_fan_cpu_ntc,
};
 ...
 */
/* GFX sys fan sensor SSD1 NTC*/
const struct thermal_level_ags i5_gfx_thermal_sys_fan_ssd1_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
    {3,     1500,     58,   54},
    {4,     1800,     61,   57},
...
const struct thermal_level_s t_i5_gfx_thermal_sys_fan_ssd1_ntc = {
    .name = "SSD1 NTC",
    .num_pairs = ARRAY_SIZE(i5_gfx_thermal_sys_fan_ssd1_ntc),
    .data = i5_gfx_thermal_sys_fan_ssd1_ntc,
};

/* GFX sys fan sensor SSD2 NTC*/
const struct thermal_level_ags i5_gfx_thermal_sys_fan_ssd2_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
...
const struct thermal_level_s t_i5_gfx_thermal_sys_fan_ssd2_ntc = {
    .name = "SSD2 NTC",
    .num_pairs = ARRAY_SIZE(i5_gfx_thermal_sys_fan_ssd2_ntc),
    .data = i5_gfx_thermal_sys_fan_ssd2_ntc,
};

/* GFX sys fan sensor MEMORY NTC*/  
const struct thermal_level_ags i5_gfx_thermal_sys_fan_memory_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      39,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      55,   38},
    {2,     1200,     58,   54},
    {3,     1500,     60,   57},
    {4,     1800,     62,   59},
...
const struct thermal_level_s t_i5_gfx_thermal_sys_fan_memory_ntc = {
    .name = "Memory NTC",
    .num_pairs = ARRAY_SIZE(i5_gfx_thermal_sys_fan_memory_ntc),
    .data = i5_gfx_thermal_sys_fan_memory_ntc,
};

/* GFX cpu fan CPU DTS */
const struct thermal_level_ags gfx_i5_thermal_cpu_fan_cpu_dts[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     68,   33},
    {2,     1200,     75,   66},
...
const struct thermal_level_s t_i5_gfx_thermal_cpu_fan_cpu_dts = {
    .name = "CPU DTS",
    .num_pairs = ARRAY_SIZE(gfx_i5_thermal_cpu_fan_cpu_dts),
    .data = gfx_i5_thermal_cpu_fan_cpu_dts,
};

/* GFX cpu fan CPU NTC */
const struct thermal_level_ags gfx_i5_thermal_cpu_fan_cpu_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     800,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     62,   33},
    {2,     1200,     70,   60},
...
const struct thermal_level_s t_i5_gfx_thermal_cpu_fan_cpu_ntc = {
    .name = "CPU NTC ",
    .num_pairs = ARRAY_SIZE(gfx_i5_thermal_cpu_fan_cpu_ntc),
    .data = gfx_i5_thermal_cpu_fan_cpu_ntc,
};
 ...
 */
/* GFX sys fan sensor SSD1 NTC*/
const struct thermal_level_ags i7_gfx_thermal_sys_fan_ssd1_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
...
const struct thermal_level_s t_i7_gfx_thermal_sys_fan_ssd1_ntc = {
    .name = "SSD1 NTC",
    .num_pairs = ARRAY_SIZE(i7_gfx_thermal_sys_fan_ssd1_ntc),
    .data = i7_gfx_thermal_sys_fan_ssd1_ntc,
};

/* GFX sys fan sensor SSD2 NTC*/
const struct thermal_level_ags i7_gfx_thermal_sys_fan_ssd2_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      40,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      52,   39},
    {2,     1200,     55,   51},
...
const struct thermal_level_s t_i7_gfx_thermal_sys_fan_ssd2_ntc = {
    .name = "SSD2 NTC",
    .num_pairs = ARRAY_SIZE(i7_gfx_thermal_sys_fan_ssd2_ntc),
    .data = i7_gfx_thermal_sys_fan_ssd2_ntc,
};

/* GFX sys fan sensor MEMORY NTC*/
const struct thermal_level_ags i7_gfx_thermal_sys_fan_memory_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      39,   GFX_SYS_FAN_START_TEMP},
    {1,     900,      55,   38},
    {2,     1200,     58,   54},
...
const struct thermal_level_s t_i7_gfx_thermal_sys_fan_memory_ntc = {
    .name = "Memory NTC",
    .num_pairs = ARRAY_SIZE(i7_gfx_thermal_sys_fan_memory_ntc),
    .data = i7_gfx_thermal_sys_fan_memory_ntc,
};

/* GFX cpu fan CPU DTS */      
const struct thermal_level_ags gfx_i7_thermal_cpu_fan_cpu_dts[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     70,   33},
    {2,     1200,     74,   68},
    {3,     1500,     80,   72},
    {4,     1700,     88,   78},
...
const struct thermal_level_s t_i7_gfx_thermal_cpu_fan_cpu_dts = {
    .name = "CPU DTS",
    .num_pairs = ARRAY_SIZE(gfx_i7_thermal_cpu_fan_cpu_dts),
    .data = gfx_i7_thermal_cpu_fan_cpu_dts,
};
            
/* GFX cpu fan CPU NTC */      
const struct thermal_level_ags gfx_i7_thermal_cpu_fan_cpu_ntc[] = {
/* level    RPM        HowTri       lowTri */
    {0,     700,      35,   GFX_CPU_FAN_START_TEMP},
    {1,     1000,     60,   33},
    {2,     1200,     74,   58},
...
const struct thermal_level_s t_i7_gfx_thermal_cpu_fan_cpu_ntc = {
    .name = "CPU NTC ",
    .num_pairs = ARRAY_SIZE(gfx_i7_thermal_cpu_fan_cpu_ntc),
    .data = gfx_i7_thermal_cpu_fan_cpu_ntc,
};
...
int cpu_fan_check_RPM(uint8_t thermalMode)
{
    ...
    switch(thermalMode) { 
        ...
        case THERMAL_WITH_GFX:
            if (0x01 == cpu_model) {
                fantable_cpu_dts = &t_i3_gfx_thermal_cpu_fan_cpu_dts;
                fantable_cpu_ntc = &t_i3_gfx_thermal_cpu_fan_cpu_ntc;
            } else if (0x02 == cpu_model) {
                fantable_cpu_dts = &t_i5_gfx_thermal_cpu_fan_cpu_dts;
                fantable_cpu_ntc = &t_i5_gfx_thermal_cpu_fan_cpu_ntc;
            } else {
                fantable_cpu_dts = &t_i7_gfx_thermal_cpu_fan_cpu_dts;
                fantable_cpu_ntc = &t_i7_gfx_thermal_cpu_fan_cpu_ntc;
            }
...
int sys_fan_check_RPM(uint8_t thermalMode)
{
    ...
    switch(thermalMode) {
        ...
        case THERMAL_WITH_GFX:
            if (0x01 == cpu_model) {
                fantable_ssd1_ntc = &t_i3_gfx_thermal_sys_fan_ssd1_ntc;
                fantable_ssd2_ntc = &t_i3_gfx_thermal_sys_fan_ssd2_ntc;
                fantable_memory_ntc = &t_i3_gfx_thermal_sys_fan_memory_ntc;
            } else if (0x02 == cpu_model) {
                fantable_ssd1_ntc = &t_i5_gfx_thermal_sys_fan_ssd1_ntc;
                fantable_ssd2_ntc = &t_i5_gfx_thermal_sys_fan_ssd2_ntc;
                fantable_memory_ntc = &t_i5_gfx_thermal_sys_fan_memory_ntc;
            } else {
                fantable_ssd1_ntc = &t_i7_gfx_thermal_sys_fan_ssd1_ntc;
                fantable_ssd2_ntc = &t_i7_gfx_thermal_sys_fan_ssd2_ntc;
                fantable_memory_ntc = &t_i7_gfx_thermal_sys_fan_memory_ntc;
            }
...
void temperature_protection_mechanism(void)
{
    ...
    if (g_fanProtect[TEMP_SENSOR_CPU_DTS].time >= TEMP_PROTECTION_COUNT) {
        update_cause_flag(FORCE_POWER_OFF_THERMAL, 1);
